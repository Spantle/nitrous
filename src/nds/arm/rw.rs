use crate::nds::{bus::BusTrait, dma::DmaTrait, logger, shared::Shared};

use super::{models::PowerDownMode, Arm, ArmKind, ArmTrait};

pub trait ArmInternalRW<Bus: BusTrait<Dma>, Dma: DmaTrait<Bus>> {
    fn read_bulk(
        &self,
        bus: &mut Bus,
        shared: &mut Shared,
...
impl<Bus: BusTrait<Dma>, Dma: DmaTrait<Bus>> ArmInternalRW<Bus, Dma> for Arm<Bus, Dma> {
    fn read_bulk(
        &self,
        bus: &mut Bus,
        shared: &mut Shared,
