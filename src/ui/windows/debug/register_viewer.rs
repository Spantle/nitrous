...
impl RegisterViewerWindow {
    ...
    fn values(&self, emulator: &Emulator) -> Vec<u32> {
        [
            ...
            emulator.shared.gpus.a.bgxcnt[0].value() as u32,
            emulator.shared.gpus.a.bgxcnt[1].value() as u32,
            emulator.shared.gpus.a.bgxcnt[2].value() as u32,
            emulator.shared.gpus.a.bgxcnt[3].value() as u32,
            emulator.shared.gpus.b.dispcnt.value(),
            emulator.shared.gpus.b.bgxcnt[0].value() as u32,
            emulator.shared.gpus.b.bgxcnt[1].value() as u32,
            emulator.shared.gpus.b.bgxcnt[2].value() as u32,
            emulator.shared.gpus.b.bgxcnt[3].value() as u32,
            emulator.shared.keyinput.value() as u32,
            emulator.shared.extkeyin.value() as u32,
