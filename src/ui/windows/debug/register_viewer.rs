...
impl RegisterViewerWindow {
    ...
    fn values(&self, emulator: &Emulator) -> Vec<usize> {
        [
            ...
            emulator.shared.gpus.vramcnt[0] as usize,
            emulator.shared.gpus.vramcnt[1] as usize,
            emulator.shared.gpus.vramcnt[2] as usize,
            emulator.shared.gpus.vramcnt[3] as usize,
            emulator.shared.gpus.vramcnt[4] as usize,
            emulator.shared.gpus.vramcnt[5] as usize,
            emulator.shared.gpus.vramcnt[6] as usize,
            emulator.shared.gpus.vramcnt[7] as usize,
            emulator.shared.gpus.vramcnt[8] as usize,
            emulator.shared.gpus.vramcnt[9] as usize,
