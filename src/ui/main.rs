...
pub struct NitrousGUI {
    ...
    #[serde(skip)]
    pub arm9_disassembler_jump_now: Option<u32>,
    #[serde(skip)]
    pub arm9_disassembler_step_amount: String,
    #[serde(skip)]
    pub arm9_disassembler_step_until: Option<u32>,
    ...
    #[serde(skip)]
    pub arm7_disassembler_jump_now: Option<u32>,
    #[serde(skip)]
    pub arm7_disassembler_step_amount: String,
    #[serde(skip)]
    pub arm7_disassembler_step_until: Option<u32>,
...
impl Default for NitrousGUI {
    fn default() -> Self {
        NitrousGUI {
            ...
            arm9_disassembler_jump_now: None,
            arm9_disassembler_step_amount: "1".to_string(),
            arm9_disassembler_step_until: None,
            ...
            arm7_disassembler_jump_now: None,
            arm7_disassembler_step_amount: "1".to_string(),
            arm7_disassembler_step_until: None,
